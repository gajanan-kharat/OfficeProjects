...
/**
 * This class is use to carry over the selected EDS to other projects without modifications.
 * <ul>
 * It performs the following operations:
 * <li>Create Re-conduction without modification pop-up.</li>
 ...
 */
public class ReconductionWithoutModifWindow extends A_EdsWindow {
    // PUBLIC
    /**
     ...
     */
    public ReconductionWithoutModifWindow(A_EdsReadForm readForm, A_EdsEditForm editForm, EdsApplicationController controller) {
        super(controller.getBundle().getString("eds-pop-recond-no-modif-title"));
        ...
        if (!projects.isEmpty()) {
            ...
            okButton.addListener(new Button.ClickListener() {
                public void buttonClick(Button.ClickEvent event) {
                    controller.reconduct(edsSource, new ArrayList<EdsProject>((Set) vLSTprojects.getValue()), false);
