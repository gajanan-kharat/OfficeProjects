 ...
 * @see ChsFilterManagerView, DetachedCriteria
 */
public class ChsFilterManager implements Serializable {
    // PUBLIC
    /**
     ...
     */
    public ChsFilterManager(EdsApplicationController controller) {
    ...
    public DetachedCriteria buildQuery() {
        DetachedCriteria criteria = DetachedCriteria.forClass(Chs.class, "chs");

        EdsUser user = controller.getAuthenticatedUser();

        if (user.getEdsRole().isPerimeter()) {
            HashSet<String> elligibleEdses = new HashSet<String>();

            DetachedCriteria perimeterSubQuery = DetachedCriteria.forClass(Chs.class);
            ...
            DetachedCriteria followerProjectsPerimeterSubQuery = DetachedCriteria.forClass(Chs.class);
            ...
            DetachedCriteria setterProjectPerimeterSubQuery = DetachedCriteria.forClass(Chs.class);
