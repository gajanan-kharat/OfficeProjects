 ...
 */
public class ChsDescriptionFilter extends A_EdsFilter {
    // PUBLIC
    /**
     ...
     */
    public ChsDescriptionFilter(String edsName, int filterType, EdsApplicationController controller) {
        super(controller);
    ...
    public String describe() {
        switch (filterType) {
        case EdsFilterManager.FILTER_EQUALS:
            return MessageFormat.format(controller.getBundle().getString("chs-filter-desc-equal"), edsName);
        case EdsFilterManager.FILTER_ISLIKE:
            return MessageFormat.format(controller.getBundle().getString("chs-filter-desc-in"), edsName);
        default:
            return null;
        }
    }
     ...
     */
    private static final Property name = Property.forName("description");
    /**
