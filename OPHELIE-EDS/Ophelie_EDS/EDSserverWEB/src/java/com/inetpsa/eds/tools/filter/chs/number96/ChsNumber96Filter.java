...
/**
 * Filter plug according to a 96XXX.
 * 
 * @author Joao Costa @ Alter Frame
 */
public class ChsNumber96Filter extends A_EdsFilter {
    // PUBLIC
    /**
     ...
     */
    public ChsNumber96Filter(String edsName, int filterType, EdsApplicationController controller) {
        super(controller);
    ...
    public String describe() {
        switch (filterType) {
        case EdsFilterManager.FILTER_EQUALS:
            return MessageFormat.format(controller.getBundle().getString("chs-filter-96xxx-equal"), edsName);
        case EdsFilterManager.FILTER_ISLIKE:
            return MessageFormat.format(controller.getBundle().getString("chs-filter-96xxx-in"), edsName);
        default:
            return null;
        }
    }
     ...
     */
    private static final Property name = Property.forName("userRef2");
    /**
