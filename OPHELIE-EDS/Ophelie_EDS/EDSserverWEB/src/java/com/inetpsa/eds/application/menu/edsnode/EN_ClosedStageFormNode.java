...
/**
 * This class represents the component representing the node "Closed stage" in menu "EDS navigation".
 * 
 * @author Geometric Ltd.
 */
public class EN_ClosedStageFormNode extends EN_FormNode {
    // PUBLIC
    /**
     ...
     */
    public EN_ClosedStageFormNode(EdsApplicationController controller, A_EdsReadForm readForm, A_EdsEditForm editForm, String editRight) {
    ...
    protected void rebuildIdleActionBar() {
        ...
        if (controller.retrieveEdsStage(readForm.getEds(), readForm.getEds().getEdsProject()) > EdsApplicationController.CLOSED_STAGE) // TODO :
                                                                                                                                       // Mettre le
                                                                                                                                       // projet
                                                                                                                                       // courant au
                                                                                                                                       // lieu du
