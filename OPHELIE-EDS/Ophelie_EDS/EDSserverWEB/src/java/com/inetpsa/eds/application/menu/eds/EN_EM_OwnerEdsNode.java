...
import com.inetpsa.eds.tools.filter.owner.EdsOwnerFilter;
import com.vaadin.ui.Layout;

/**
 * This class represents the component representing the node "My EDS" of "EDS Browser" menu.
 * 
 * @author Geometric Ltd.
 */
public class EN_EM_OwnerEdsNode extends A_EN_EdsMenuNode {
    // PUBLIC
    /**
     ...
     */
    public EN_EM_OwnerEdsNode(EdsApplicationController controller) {
        super(controller);
        init();
    }
    ...
    public String getCaption() {
        return controller.getBundle().getString("menu-app-Fich");
    }
    ...
    /**
     * This method is used to retrieve the "My EDS" view.
     * 
    ...
    public Layout getView() {
        if (edsListView == null) {
            ...
            edsListView.getFilterPanel().getFilterManagerView().addFilter(new EdsOwnerFilter(controller.getAuthenticatedUser(), controller));
        }
    ...
    // PRIVATE
    /**
     * Variable to store the "My EDS" list view component.
     */
