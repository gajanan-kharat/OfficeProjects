...
import com.inetpsa.eds.tools.filter.pending.EdsPendingFilter;
import com.vaadin.ui.Layout;

/**
 * This class represents component representing the node "EDS in process" in menu "Dashboard."
 * 
 * @author Geometric Ltd.
 */
public class EN_DB_PendingEdsNode extends A_EN_DashBoardNode {
    // PUBLIC
    /**
     ...
     */
    public EN_DB_PendingEdsNode(EdsApplicationController controller) {
        super(controller);
        init();
    }
    ...
    /**
     * This method is used to retrieve the "EDS in process" view.
     * 
     * @return "EDS in process" component.
     */
    public Layout getView() {
        if (edsListView == null) {
            edsListView = new DashBoardEDSListView(getController());
            edsListView.getFilterPanel().getFilterManagerView().addFilter(new EdsPendingFilter(controller));
        }
    ...
    // PRIVATE
    /**
     * Variable to store the "EDS in process" list view component.
     */
