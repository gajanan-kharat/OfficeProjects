...
/**
 * This class represents the component representing the node "Consolidated stage" in menu "EDS navigation".
 * 
 * @author Geometric Ltd.
 */
public class EN_ConsolidatedStageFormNode extends EN_FormNode {
    // PUBLIC
    /**
     ...
     */
    public EN_ConsolidatedStageFormNode(EdsApplicationController controller, A_EdsReadForm readForm, A_EdsEditForm editForm, String editRight) {
    ...
    protected void rebuildIdleActionBar() {
        if (controller.retrieveEdsStage(readForm.getEds(), readForm.getEds().getEdsProject()) > EdsApplicationController.SOLID_STAGE) // TODO : Mettre
                                                                                                                                      // le projet
                                                                                                                                      // courant au
                                                                                                                                      // lieu du
                                                                                                                                      // projet
