...
/**
 * This class represents the component representing the node "Robust stage" in menu "EDS navigation".
 * 
 * @author Geometric Ltd.
 */
public class EN_RobustStageFormNode extends EN_FormNode {
    // PUBLIC
    /**
     ...
     */
    public EN_RobustStageFormNode(EdsApplicationController controller, A_EdsReadForm readForm, A_EdsEditForm editForm, String editRight) {
    ...
    protected void rebuildIdleActionBar() {
        if (controller.retrieveEdsStage(readForm.getEds(), readForm.getEds().getEdsProject()) > EdsApplicationController.ROBUST_STAGE) // TODO :
                                                                                                                                       // Mettre le
                                                                                                                                       // projet
                                                                                                                                       // courant au
                                                                                                                                       // lieu du
