 ...
 */
public class FF_ChsNbEmbases extends A_FilterFactory {
    // PUBLIC
    /**
     * Constant to hold value of FACTORY_NAME
     */
    public static final String FACTORY_NAME = "chs-filter-embnum";
     ...
     */
    public FF_ChsNbEmbases(EdsApplicationController controller) {
    ...
    protected A_FilterEditor buildEditor() {
        return new FE_ChsNbEmbases(controller);
    }
