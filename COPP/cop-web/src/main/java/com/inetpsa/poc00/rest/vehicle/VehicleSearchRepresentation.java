 ...
 */
public class VehicleSearchRepresentation {
	 ...
	 */
	public void setFuelList(List<Long> fuelList) {
	 ...
	 */
	public void setEmsList(List<Long> emsList) {
