...
import com.inetpsa.poc00.rest.inertia.InertiaRepresentation;

/**
 * The Class CoastdownRepresentation.
 */
public class CoastdownRepresentation {
	...
	/** The inertia. */
	private InertiaRepresentation inertia;

	/**
	 * Instantiates a new coastdown representation.
	 */
	public CoastdownRepresentation() {
		super();
	}
	 ...
	 * @param inertia_value the inertia_value
	 * @param latestversion the latestversion
	 * @param entityId the entity id
	 */
	public CoastdownRepresentation(String pSAReference, String roadLaw, Double theoricalBenchF0, Double theoricalBenchF1, Double theoricalBenchF2, Double computedBenchF0, Double computedBenchF1, Double computedBenchF2, String version, int inertia_value, Boolean latestversion, Long entityId) {
	 ...
	 * @param entityId the entity id
	 */
	public CoastdownRepresentation(String version, Long entityId) {
		this.entityId = entityId;
		this.version = version;
	}
	 ...
	 * @param pSAReference the SA reference
	 */
	public CoastdownRepresentation(Long entityId, String pSAReference) {
		this.entityId = entityId;
		this.pSAReference = pSAReference;
	}
	 ...
	 * @return the inertia
	 */
	public InertiaRepresentation getInertia() {
		return inertia;
	}
	 ...
	 */
	public void setInertia(InertiaRepresentation inertia) {
