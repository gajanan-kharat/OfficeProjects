...
/**
 * The Class OpacityDecisionParametersRepresentation.
 */
public class OpacityDecisionParametersRepresentation {
	...
	public String toString() {
		return "OpacityDecisionParametersRepresentation [highLimit=" + higherLimit + ", highSymbol=" + higherSymbol + ", lowLimit=" + lowerLimit + ", lowSymbol=" + lowerSymbol + ", fuelLabel=" + fuelTypeLabel + "]";
	}
