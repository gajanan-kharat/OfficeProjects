...
/**
 * The Class CODecisionParametersRepresentation.
 */
public class CODecisionParametersRepresentation {
	...
	public String toString() {
		return "CODecisionParametersRepresentation [entityId=" + entityId + ", higherLimit=" + higherLimit + ", higherSymbol=" + higherSymbol + ", lowerLimit=" + lowerLimit + ", lowerSymbol=" + lowerSymbol + ", fuelTypeLabel=" + fuelTypeLabel + ", edited=" + edited + "]";
	}
