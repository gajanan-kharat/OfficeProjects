...
public class MonteCarloReportServiceImpl implements ReportService {
    ...
    public String generateReport() throws IOException {
        ...
        rowIdx = ReportUtility.generateRequirementTree(summarySheet, rowIdx++, colIdx, NB_COL, motherReqList, new HashMap<String, XSSFCellStyle>(), new ArrayList<Integer>());
        ...
        String reportPath = ReportUtility.getRepositoryPath(CalculationType.MONTE_CARLO, ReportUtility.REPORT, executionDate) + ReportUtility.formateReportDate(executionDate)
                + ReportUtility.REPORT_EXTENSION;
     ...
     */
    private void generateResultsSection(XSSFSheet sheet, SciMotherRequirementType motherReq, int rowIdx, Map<String, XSSFCellStyle> styles) throws IOException {
        ...
        paramStyles.put(ReportUtility.ParamType.ALPHA, ReportUtility.createParCellStyle(sheet.getWorkbook(), ReportStyles.DEFAULT, ReportUtility.ParamType.ALPHA));
        paramStyles.put(ReportUtility.ParamType.BETA, ReportUtility.createParCellStyle(sheet.getWorkbook(), ReportStyles.DEFAULT, ReportUtility.ParamType.BETA));
        paramStyles.put(ReportUtility.ParamType.LAMBDA, ReportUtility.createParCellStyle(sheet.getWorkbook(), ReportStyles.DEFAULT, ReportUtility.ParamType.LAMBDA));
        paramStyles.put(ReportUtility.ParamType.MU, ReportUtility.createParCellStyle(sheet.getWorkbook(), ReportStyles.DEFAULT, ReportUtility.ParamType.MU));
        paramStyles.put(ReportUtility.ParamType.SIGMA, ReportUtility.createParCellStyle(sheet.getWorkbook(), ReportStyles.DEFAULT, ReportUtility.ParamType.SIGMA));
        paramStyles.put(ReportUtility.ParamType.N, ReportUtility.createParCellStyle(sheet.getWorkbook(), ReportStyles.DEFAULT, ReportUtility.ParamType.N));
        paramStyles.put(ReportUtility.ParamType.P, ReportUtility.createParCellStyle(sheet.getWorkbook(), ReportStyles.DEFAULT, ReportUtility.ParamType.P));
    ...
    private int generateMotherRequirementBlock(XSSFSheet sheet, SciMotherRequirementType motherReq, Map<String, XSSFCellStyle> styles, int rowIdx) {
        ...
        // 'Lower limit' column
        ReportUtility.createFormulaCell(rowLabels, 1, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "LOW_VALUE"), styles.get("firstColHeaderStyle"));
        // 'Upper limit' column
        ReportUtility.createFormulaCell(rowLabels, 2, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "UP_VALUE"), styles.get("colHeaderStyle"));
        // 'Mean' column
        ReportUtility.createFormulaCell(rowLabels, 3, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "MEAN"), styles.get("lastColHeaderStyle"));
        // 'Standard deviation' column
        ReportUtility.createFormulaCell(rowLabels, 4, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "STANDARD_DEV"), styles.get("firstColHeaderStyle"));
        // 'Cp' column
        ReportUtility.createFormulaCell(rowLabels, 5, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "CAP"), styles.get("colHeaderStyle"));
        // 'Cpk' column
        ReportUtility.createFormulaCell(rowLabels, 6, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "CPK"), styles.get("colHeaderStyle"));
        // 'Real off-centering' column
        ReportUtility.createFormulaCell(rowLabels, 7, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "OFF_CENTERING"), styles.get("colHeaderStyle"));
        // 'PPM' column
        ReportUtility.createFormulaCell(rowLabels, 8, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "PPM"), styles.get("lastColHeaderStyle"));
        ...
        /** VCOPLMPSA-29483: Code modification START. Date: 15-November-2016 */
        // 'PPM' column
        ReportUtility.createNumericCell(rowValues, 8, motherReq.getTnc() * 100, styles.get("motherStyle"));
        /** VCOPLMPSA-29483: Code modification END. Date: 15-November-2016 */
        return rowIndex;
    }
    ...
    private int generateContributorList(XSSFSheet sheet, List<SciRequirementType> contributorList, Map<String, XSSFCellStyle> styles,
        ...
        XSSFRow rowLabels = ReportUtility.createRow(sheet, rowIndex, NB_COL, false, ReportRowHeights.TABLE_HEADER);
        // 'Contributor' column
        ReportUtility.createFormulaCell(rowLabels, 1, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "CONTRIBUTOR"), styles.get("rowHeaderStyle"));
        // 'Designation' column
        ReportUtility.createFormulaCell(rowLabels, 2, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "DESIGNATION"), styles.get("firstColHeaderStyle"));
        // 'Lower limit' column
        ReportUtility.createFormulaCell(rowLabels, 3, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "LOW_VALUE"), styles.get("colHeaderStyle"));
        // 'Upper limit' column
        ReportUtility.createFormulaCell(rowLabels, 4, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "UP_VALUE"), styles.get("colHeaderStyle"));
        // 'Distribution' column
        ReportUtility.createFormulaCell(rowLabels, 5, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "DISTRIBUTION"), styles.get("colHeaderStyle"));
        // 'Parameter 1' column
        ReportUtility.createFormulaCell(rowLabels, 6, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "PARAM_1"), styles.get("colHeaderStyle"));
        // 'Parameter 2' column
        ReportUtility.createFormulaCell(rowLabels, 7, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "PARAM_2"), styles.get("lastColHeaderStyle"));
    ...
    public static void main(String[] args) throws IOException, SecurityException, IllegalArgumentException {
        ...
        SciMotherRequirementType scilabSubMotherRequirement = SciObjectInputAdapter.createScilabMotherRequirementType(subMotherRequirement, subTransferModel, subContributorList);

        SciMotherRequirementType scilabMotherRequirement = SciObjectInputAdapter.createScilabMotherRequirementType(motherRequirement, transferModel, contributorList);
