...
import com.inetpsa.oaz00.ws.report.utils.SemiQuadReportLabelsEnum;
...
/**
 * The Class Semi quad report service implementation.
 * 
 * @author U224106
 */
public class SemiQuadReportServiceImpl implements ReportService {

    /** The Constant NB_COL. */
    private final static int NB_COL = 14;

    /** The Constant LABELS_ENUM_CLASSNAME. */
    private final static String LABELS_ENUM_CLASSNAME = SemiQuadReportLabelsEnum.class.getName();
    ...
    /**
     * Instantiates a new semi quad report service impl.
     * 
     ...
     */
    public SemiQuadReportServiceImpl(SciMotherRequirementType pMotherRequirement, String pProjectName, Date pExecutionDate, String userId) {
        super();
    ...
    public String generateReport() throws IOException {
        ...
        coreProps.setRevision(executionDate.toString());
        coreProps.setKeywords("SEMI QUADRATIC SIMULATION");

        // ########### PARAM SHEET ###########
        ReportUtility.generateParameterSheet(wb, CalculationType.SEMI_QUADRATIC);
        ...
        ReportUtility.createRow(imageSheet, rowIdx++, NB_COL, false, ReportRowHeights.SECTION);
        ReportUtility.createSection(imageSheet, 5, NB_COL, LABELS_ENUM_CLASSNAME, "PICTURE");
        ...
        String reportPath = ReportUtility.getRepositoryPath(CalculationType.SEMI_QUADRATIC, ReportUtility.REPORT, executionDate)
    ...
    private int generateMotherRequirementBlock(XSSFSheet sheet, int rowIdx, Map<String, XSSFCellStyle> styles) {
        ...
        // 'Designation' column
        ReportUtility.createMergedCells(sheet, rowHeader.getRowNum(), rowHeader.getRowNum(), 4, 8, styles.get("colHeaderStyle"),
                ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "DESIGNATION"), true);
        // 'Nominal' column
        ReportUtility.createFormulaCell(rowHeader, 9, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "NOMINAL"),
                styles.get("colHeaderStyle"));
        // 'Off-Centering' column
        ReportUtility.createFormulaCell(rowHeader, 10, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "OFF_CENTERING"),
                styles.get("colHeaderStyle"));
        // 'PPM' column
        ReportUtility.createFormulaCell(rowHeader, 11, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "PPM"),
                styles.get("colHeaderStyle"));
        // 'CPK' column
        ReportUtility.createFormulaCell(rowHeader, 12, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "CPK"),
        ...
        // 'Designation' value
        ReportUtility.createMergedCells(sheet, rowValues.getRowNum(), rowValues.getRowNum(), 4, 8, styles.get("referenceStyle"),
                motherRequirement.getTitle(), false);
        // 'Nominal' value
        ReportUtility.createNumericCell(rowValues, 9, motherRequirement.getNominal(), styles.get("motherStyle"));
        // 'Off-Centering' value
        ReportUtility.createNumericCell(rowValues, 10, motherRequirement.getCenteringMax(), styles.get("motherStyle"));
        // 'PPM' value
        ReportUtility.createNumericCell(rowValues, 11, motherRequirement.getTnc(), styles.get("motherStyle"));
        // 'CPK' value
        ReportUtility.createNumericCell(rowValues, 12, motherRequirement.getCpk(), styles.get("motherStyle"));
        return rowIndex;
    }
    ...
    private int generateResultsBlock(XSSFSheet sheet, int rowIdx, Map<String, XSSFCellStyle> styles) {
        ...
        XSSFRow rowSemiQuad = ReportUtility.createRow(sheet, rowIndex++, NB_COL, false, ReportRowHeights.TABLE_VALUE);
        ...
        ReportUtility.createMergedCells(sheet, rowArith.getRowNum(), rowArith.getRowNum(), 3, 6, styles.get("rowHeaderStyle"),
        ...
        colIdx = 7;
        // ## 'Semi Quadratic' values ##
        // 'Semi Quadratic' row header
        ReportUtility.createMergedCells(sheet, rowSemiQuad.getRowNum(), rowSemiQuad.getRowNum(), 3, 6, styles.get("rowHeaderStyle"),
                ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "SEMI_QUAD"), true);
        // 'Lower limit' value
        ReportUtility.createNumericCell(rowSemiQuad, colIdx++, motherRequirement.getSemiQuadraticValueInf(), styles.get("motherStyle"));
        // 'Upper limit' value
        ReportUtility.createNumericCell(rowSemiQuad, colIdx++, motherRequirement.getSemiQuadraticValueSup(), styles.get("motherStyle"));
        // 'Lower TI' value
        ReportUtility.createNumericCell(rowSemiQuad, colIdx++, motherRequirement.getSemiQuadraticITInf(), styles.get("motherStyle"));
        // 'Upper TI' value
        ReportUtility.createNumericCell(rowSemiQuad, colIdx++, motherRequirement.getSemiQuadraticITSup(), styles.get("motherStyle"));
        // 'Tolerance interval' value
        ReportUtility.createNumericCell(rowSemiQuad, colIdx, motherRequirement.getSemiQuadraticIT(), styles.get("motherStyle"));

        colIdx = 7;
        // ## 'Statistical' values ##
        // 'Statistical' row header
        ReportUtility.createMergedCells(sheet, rowStat.getRowNum(), rowStat.getRowNum(), 3, 6, styles.get("rowHeaderStyle"),
    ...
    private int generateContributorList(XSSFSheet sheet, int rowIdx, Map<String, XSSFCellStyle> styles) {
        ...
        ReportUtility.createFormulaCell(rowHeader, colIdx++, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "NOMINAL"),
                styles.get("colHeaderStyle"));
        // 'Mean' column
        ReportUtility.createFormulaCell(rowHeader, colIdx++, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "MEAN"),
                styles.get("colHeaderStyle"));
        // 'Standard deviation' column
        ReportUtility.createFormulaCell(rowHeader, colIdx++, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "STANDARD_DEV"),
                styles.get("colHeaderStyle"));
        // 'Lower limit' column
        ReportUtility.createFormulaCell(rowHeader, colIdx++, ReportUtility.getLabelSwitchFormula(LABELS_ENUM_CLASSNAME, "LOW_VALUE"),
                styles.get("colHeaderStyle"));
        ...
        for (Iterator<SciRequirementType> iterator = motherRequirement.getContributorList().iterator(); iterator.hasNext();) {
            ...
            // 'Mean' value
            ReportUtility.createNumericCell(row, colIdx++, contributor.getMean(), styles.get("contributorStyle"));
            // 'Standard deviation' value
            ReportUtility.createNumericCell(row, colIdx++, contributor.getStandardDeviation(), styles.get("contributorStyle"));
            // 'Lower limit' value
            ...
            // 'Lower TI' value
            ReportUtility.createFormulaCell(row, colIdx++, "H" + (rowIndex + 1) + "-E" + (rowIndex + 1), styles.get("contributorStyle"));
            // 'Upper TI' value
            ReportUtility.createFormulaCell(row, colIdx++, "I" + (rowIndex + 1) + "-E" + (rowIndex + 1), styles.get("contributorStyle"));
            // 'Tolerance interval' value
            ReportUtility.createFormulaCell(row, colIdx++, "I" + (rowIndex + 1) + "-H" + (rowIndex + 1), styles.get("contributorStyle"));
            // 'Off-Centering' value
    ...
    public static void main(String[] args) throws IOException, SecurityException, IllegalArgumentException {
        ...
        contributor.setMean(new Double(7.0));
        contributor.setStandardDeviation(new Double(0.6));
        ...
        contributor.setMean(new Double(8.3));
        contributor.setStandardDeviation(new Double(0.2));
        contributorList.add(contributor);
        ...
        contributor.setMean(new Double(30.2));
        contributor.setStandardDeviation(new Double(0.08));
        contributorList.add(contributor);
        ...
        SemiQuadReportServiceImpl service = new SemiQuadReportServiceImpl(scilabMotherRequirement, "Report Generation", date.getTime(), "SIBERT");
