 ...
 */
package com.inetpsa.oaz.ws.checker.formula.services;
...
public class EquationCheckerTest extends TestCase {
	...
	/**
	 * Testing that the provided reportFormula contains any comma in between numbers
	 * @throws SecurityException
	 * @throws NoSuchMethodException
	 * @throws IllegalArgumentException
	 * @throws IllegalAccessException
	 */
	public void testCheckCommaInNumbers1() throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException {
		EquationChecker ec = new EquationChecker();
		Method m = EquationChecker.class.getDeclaredMethod("checkCommaInNumbers", String.class);
		m.setAccessible(true);
		try {
			m.invoke(ec, "min ( max( 4,5*#UR-0000211# + #UR-0000212#, #UR-0000213# ))");
		} catch (InvocationTargetException ite) {
			if (ite.getCause() instanceof EquationException) {
				EquationException ee = (EquationException) ite.getCause();
				assertEquals(12, ee.getErrorStatus().intValue());
				assertEquals(13, ee.getPosition().intValue());
				assertEquals("Invalid comma in between numbers", ee.getErrorDescription());
				System.out.println("Invalid comma in between numbers");
			}
		}
	}
	
	public void testCheckCommaInNumbers2() throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException {
		EquationChecker ec = new EquationChecker();
		Method m = EquationChecker.class.getDeclaredMethod("checkCommaInNumbers", String.class);
		m.setAccessible(true);
		try {
			m.invoke(ec, "(0,5+3*#UR-0000211#)*PI");
		} catch (InvocationTargetException ite) {
			if (ite.getCause() instanceof EquationException) {
				EquationException ee = (EquationException) ite.getCause();
				assertEquals(12, ee.getErrorStatus().intValue());
				assertEquals(3, ee.getPosition().intValue());
				assertEquals("Invalid comma in between numbers", ee.getErrorDescription());
				System.out.println("Invalid comma in between numbers");
			}
		}
	...
	public void testCheckCommaInNumbers3() throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException {
		EquationChecker ec = new EquationChecker();
		Method m = EquationChecker.class.getDeclaredMethod("checkCommaInNumbers", String.class);
		m.setAccessible(true);
		try {
			m.invoke(ec, "sin(3,5*#UR-0000210#*#UR-0000211#)");
		} catch (InvocationTargetException ite) {
			if (ite.getCause() instanceof EquationException) {
				EquationException ee = (EquationException) ite.getCause();
				assertEquals(12, ee.getErrorStatus().intValue());
	...
	public void testCheckCommaInNumbers4() throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException {
		EquationChecker ec = new EquationChecker();
		Method m = EquationChecker.class.getDeclaredMethod("checkCommaInNumbers", String.class);
		m.setAccessible(true);
		try {
			m.invoke(ec, "0,5*#UR-0000211#");
		} catch (InvocationTargetException ite) {
			if (ite.getCause() instanceof EquationException) {
				EquationException ee = (EquationException) ite.getCause();
				assertEquals(12, ee.getErrorStatus().intValue());
				assertEquals(2, ee.getPosition().intValue());
				assertEquals("Invalid comma in between numbers", ee.getErrorDescription());
				System.out.println("Invalid comma in between numbers");
			}
		}
	...
	public void testCheckCommaInNumbers5() throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException {
		EquationChecker ec = new EquationChecker();
		Method m = EquationChecker.class.getDeclaredMethod("checkCommaInNumbers", String.class);
		m.setAccessible(true);
		try {
			m.invoke(ec, "sin(#UR-0000210#3,5#UR-0000211#)");
		} catch (InvocationTargetException ite) {
			if (ite.getCause() instanceof EquationException) {
				EquationException ee = (EquationException) ite.getCause();
				assertEquals(12, ee.getErrorStatus().intValue());
				assertEquals(18, ee.getPosition().intValue());
				assertEquals("Invalid comma in between numbers", ee.getErrorDescription());
				System.out.println("Invalid comma in between numbers");
			}
		}
	...
	public void testCheckCommaInNumbers6() throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException {
		EquationChecker ec = new EquationChecker();
		Method m = EquationChecker.class.getDeclaredMethod("checkCommaInNumbers", String.class);
		m.setAccessible(true);
		try {
			m.invoke(ec, "sin(100*#UR-0000210#-#UR-0000211#*2,5)");
		} catch (InvocationTargetException ite) {
			if (ite.getCause() instanceof EquationException) {
				EquationException ee = (EquationException) ite.getCause();
				assertEquals(12, ee.getErrorStatus().intValue());
	...
	public void testCheckCommaInNumbers7() throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException {
		EquationChecker ec = new EquationChecker();
		Method m = EquationChecker.class.getDeclaredMethod("checkCommaInNumbers", String.class);
		m.setAccessible(true);
		try {
	...
	public void testCheckCommaInNumbers8() throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException {
		EquationChecker ec = new EquationChecker();
		Method m = EquationChecker.class.getDeclaredMethod("checkCommaInNumbers", String.class);
		m.setAccessible(true);
		try {
			m.invoke(ec, "min(sin(4,5*UR1);UR2)");
		} catch (InvocationTargetException ite) {
			if (ite.getCause() instanceof EquationException) {
				EquationException ee = (EquationException) ite.getCause();
				assertEquals(12, ee.getErrorStatus().intValue());
				assertEquals(10, ee.getPosition().intValue());
				assertEquals("Invalid comma in between numbers", ee.getErrorDescription());
				System.out.println("Invalid comma in between numbers");
			}
		}
	...
	public void testCheckCommaInNumbers9() throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException {
		EquationChecker ec = new EquationChecker();
		Method m = EquationChecker.class.getDeclaredMethod("checkCommaInNumbers", String.class);
		m.setAccessible(true);
		try {
			m.invoke(ec, "sin ( 4,8*PI )");
		} catch (InvocationTargetException ite) {
			if (ite.getCause() instanceof EquationException) {
				EquationException ee = (EquationException) ite.getCause();
				assertEquals(12, ee.getErrorStatus().intValue());
	...
	public void testCheckCommaInNumbers10() throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException {
		EquationChecker ec = new EquationChecker();
		Method m = EquationChecker.class.getDeclaredMethod("checkCommaInNumbers", String.class);
		m.setAccessible(true);
		try {
			m.invoke(ec, "max( 4,5*#UR1#,#UR2# )");
		} catch (InvocationTargetException ite) {
			if (ite.getCause() instanceof EquationException) {
				EquationException ee = (EquationException) ite.getCause();
				assertEquals(12, ee.getErrorStatus().intValue());
				assertEquals(7, ee.getPosition().intValue());
				assertEquals("Invalid comma in between numbers", ee.getErrorDescription());
				System.out.println("Invalid comma in between numbers");
			}
		}
