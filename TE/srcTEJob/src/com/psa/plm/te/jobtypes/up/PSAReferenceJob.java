...
public class PSAReferenceJob extends PSAUpExchngAutomation {

    private static final String strExaSubfolder = "reference";

    public PSAReferenceJob(String strJobID) {
        super(strJobID);
        strJobType = "plm_te_upward_reference";
    }
