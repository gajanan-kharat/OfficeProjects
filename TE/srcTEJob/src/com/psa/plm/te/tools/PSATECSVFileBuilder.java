...
public class PSATECSVFileBuilder {
    private String _strFileName = "";
    private Writer _csvWriter;

    public PSATECSVFileBuilder(String strFile) {
    ...
    public int PrepareCSVFile() {
        int nRet = 0;
        try {
            _csvWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(_strFileName), "Cp1252"));
        } catch (Exception e) {
