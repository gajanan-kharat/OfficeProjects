...
public class CreateFilterForm extends JDialog {
    ...
    public CreateFilterForm() {
        ...
        lastConstraints.insets = new Insets(1, 0, 5, 5);
    ...
    /**
     * Adds an arbitrary label component, starting a new row if appropriate. The width of the component will be set to the minimum width of the widest
    ...
    /**
     * Adds a "middle" field component. Any component may be used. The component will be stretched to take all of the space between the label and the
